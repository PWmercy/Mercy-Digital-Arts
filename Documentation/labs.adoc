...
[NOTE]
.*_IF YOU DON’T SEE_* the above drives and folders
====
...
WARNING: The __
My-Stuff__ folder is the ONLY area that is private to you. Anything that is left outside this folder is visible to anyone and could potentially be deleted.
