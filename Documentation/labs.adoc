...
then DOUBLE-Click on “cata‑nas‑ha” and log in as above.

image:media/networkcatanasha.png[image,width=210,height=97]
...
<<StudentandFacultyresources.adoc#,Return to main Resources page>>
