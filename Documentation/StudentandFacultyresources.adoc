...
*This page is updated as new information becomes available.* Last updated {revdate}
...
.Via Zoom
** Connect to Zoom Meeting Room {pwhite-zoom-room}[here, window="_blank"]
...
Click <<labs.adoc#,here>> for instructions

=== Files on campus server

<<labs.adoc#_accessing_files,General Information on Accessing Files Here>>

* As of March 2020, the class folders are automatically synchronized with a OneDrive cloud. This allows you to have access when not on campus.
** Files added or changed in the lab will be there when you are home and vice-versa.
** Connect https://mercyedu-my.sharepoint.com/:f:/g/personal/sp_odr_cata_1_mercy_edu/EiUbRLkBcP5LhOXE2nBjQKkB1sOTPFDOXP9PTe6eAVqUiQ?e=qr0fur[here].
...
IMPORTANT: *NOT* active yet as of {revdate}
...
* All Design+Animation majors receive a license.
** You should have already received a notice from Adobe (sent to your mercy.edu email). If you haven't, contact {author_email}
