...
**Video instructions https://munki6.digiarts.mercy:8090/Video_Help/Connect_to_Pro_Tools_license_1.mp4[here]**

. Open ilok License Manager - you do _not_ need to Sign In
