...
** http://172.31.48.93:22352[Reason] (license server deprecated, see <<_software_reason, Reason>> under Software)
...
* [line-through]#Reposado/Margarita#
...
* https://www.production-expert.com/production-expert-1/macos-sonoma-compatibility-the-ultimate-pro-audio-guide?utm_source=convertkit&utm_medium=email&utm_campaign=macOS+Sonoma+Compatibility+-+The+Ultimate+Pro+Audio+Guide%20-%2011811810[Sonoma Compatibility (2023)]
