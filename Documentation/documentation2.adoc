...
=== License servers
** http://172.31.48.93:22352[Reason] (license server deprecated, see below)

*** As of Reason 12, network multi-license not possible. Machines are individually authorized.

*** Login to ReasonStudios online account

IMPORTANT: Local authorization still requires that CodeMeter be installed.
