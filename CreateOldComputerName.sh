...
# to a form compatible with their 15 character limit, e.g., vh200mc99999mac01
# In order to sort in ARD, this script puts a name in the old format in Computer Info field 2
# For now, script relies on new format with exact length so will not work with "inst"
